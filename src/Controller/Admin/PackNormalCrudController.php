...
class PackNormalCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return PackNormal::class;
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle('index', 'Packs Normal')
            ->setEntityLabelInSingular('Pack Normal')
