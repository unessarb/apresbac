 ...
 */
final class Version20230213142950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE banner CHANGE is_valid is_active TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE banner CHANGE is_active is_valid TINYINT(1) NOT NULL');
