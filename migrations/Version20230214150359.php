 ...
 */
final class Version20230214150359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ville DROP region');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ville ADD region VARCHAR(255) DEFAULT NULL');
    }
}
